...
export class AuthorizeService {
  ...
  async signIn(
    ...
    try {
      ...
      try {
        ...
        this.updateState(popUpUser || null);
        return this.success(state);
      } catch (popUpError) {
  ...
  async completeSignIn(
    ...
    try {
      await this.ensureUserManagerInitialized();
      const user =
        this.userManager && (await this.userManager.signinCallback(url));
  ...
  async completeSignOut(
    ...
    try {
      const response =
        this.userManager && (await this.userManager.signoutCallback(url));
      this.updateState(null);
